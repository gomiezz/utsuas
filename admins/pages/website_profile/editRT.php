...
$q = mysqli_query($conn, "SELECT * FROM website_profile WHERE judul='rt'");
...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('rt berhasil diupdate!'); window.location.href='index.php?page=rt';</script>";
    exit;
}
?>

<h1>Edit Running Teks</h1>

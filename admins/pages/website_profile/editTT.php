...
$q = mysqli_query($conn, "SELECT * FROM website_profile WHERE judul='tt'");
...
if (isset($_POST['update'])) {
    ...
    echo "<script>alert('tt berhasil diupdate!'); window.location.href='index.php?page=tt';</script>";
    exit;
}
?>

<h1>Edit Tentang Toko</h1>
